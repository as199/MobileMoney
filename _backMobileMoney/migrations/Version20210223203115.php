 ...
 */
final class Version20210223203115 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE utilisateur_transaction (utilisateur_id INT NOT NULL, transaction_id INT NOT NULL, INDEX IDX_86D108422FC0CB0F (transaction_id), INDEX IDX_86D10842FB88E14F (utilisateur_id), PRIMARY KEY(utilisateur_id, transaction_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
