 ...
 */
final class Version20210223155032 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD agence_id INT DEFAULT NULL, ADD type_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur DROP agence_id, DROP type_id');
    }
}
